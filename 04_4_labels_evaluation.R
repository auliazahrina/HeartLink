...
data <- read.csv(file="data.4_labels.csv")
...
for (i in 1:10)
{
  ...
  #Store metrics
  accuracy <- c(accuracy,(table[1,1]+table[2,2]+table[3,3]+table[4,4])/sum(sum(table)))
  
  precision0 <- c(precision0,(table[1,1]/(table[1,1] + table[1,2] + table[1,3] + table[1,4])))
  precision1 <- c(precision1,(table[2,2]/(table[2,1] + table[2,2] + table[2,3] + table[2,4])))
  precision2 <- c(precision2,(table[3,3]/(table[3,1] + table[3,2] + table[3,3] + table[3,4])))
  precision3 <- c(precision3,(table[4,4]/(table[4,1] + table[4,2] + table[4,3] + table[4,4])))
  
  recall0 <- c(recall0, (table[1,1]/(table[1,1] + table[2,1] + table[3,1] + table[4,1])))
  recall1 <- c(recall1, (table[2,2]/(table[1,2] + table[2,2] + table[3,2] + table[4,2])))
  recall2 <- c(recall2, (table[3,3]/(table[1,3] + table[2,3] + table[3,3] + table[4,3])))
  recall3 <- c(recall3, (table[4,4]/(table[1,4] + table[2,4] + table[3,4] + table[4,4])))
